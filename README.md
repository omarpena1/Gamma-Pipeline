...
2. The jupyter notebook's stored in folder "/notebooks/" are flexible and light-weight wrappers which call on functions whose complicated logic is stored in the .py files and access the data stored in "/artifacts/".
